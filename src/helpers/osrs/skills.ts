...
export const osrsSkills: Skills = {
  attack: {
    ...
    emoji: "⚔️",
    compliment: "You're a fierce warrior!",
  },
  defence: {
    ...
    emoji: "🛡️",
    compliment: "You're a stalwart defender!",
  },
  strength: {
    ...
    emoji: "💪",
    compliment: "You're incredibly strong!",
  },
  hitpoints: {
    ...
    emoji: "❤️",
    compliment: "You're incredibly resilient!",
  },
  ranged: {
    ...
    emoji: "🎯",
    compliment: "You have amazing aim!",
  },
  magic: {
    ...
    emoji: "✨",
    compliment: "You're a magical prodigy!",
  },
  cooking: {
    ...
    emoji: "🍳",
    compliment: "You're a master chef!",
  },
  prayer: {
    ...
    emoji: "🙏",
    compliment: "You have a strong connection to the divine!",
  },
  woodcutting: {
    ...
    emoji: "🪓",
    compliment:
      "You're a true lumberjack with the strength and skill to make quick work of any tree.",
  },
  fletching: {
    ...
    emoji: "🏹",
    compliment:
      "Your precision and attention to detail in crafting bows and arrows is unmatched.",
  },
  fishing: {
    ...
    emoji: "🎣",
    compliment:
      "You have the patience and technique to reel in even the biggest catch of the day.",
  },
  firemaking: {
    ...
    compliment:
      "You know just how to use fire to warm yourself and light the way for others.",
    emoji: "🔥",
  },
  crafting: {
    ...
    compliment:
      "Your creativity and dexterity make you a master of all sorts of handiwork.",
    emoji: "🧵",
  },
  smithing: {
    ...
    compliment: "Your mastery of metalworking and forging is second to none.",
    emoji: "🔨",
  },
  mining: {
    ...
    compliment:
      "You have the strength and endurance to dig deep and uncover the rarest minerals.",
    emoji: "⛏️",
  },
  herblore: {
    ...
    compliment:
      "You possess a deep knowledge of the natural world and the power of plants to heal and enhance.",
    emoji: "🌿",
  },
  agility: {
    ...
    compliment:
      "You move with speed and grace, always ready to tackle any obstacle in your way.",
    emoji: "🏃‍♂️",
  },
  thieving: {
    ...
    compliment:
      "Your skills in the shadows and sleight of hand make you a master of the art of thievery.",
    emoji: "💰",
  },
  slayer: {
    ...
    compliment:
      "You fearlessly face the most dangerous monsters and emerge victorious every time.",
    emoji: "💀",
  },
  farming: {
    ...
    emoji: "🌱",
    compliment:
      "Your green thumb and nurturing spirit make you a true steward of the land.",
  },
  runecraft: {
    ...
    compliment:
      "Your knowledge of ancient magic and symbols allows you to weave powerful spells and enchantments.",
    emoji: "🔮",
  },
  hunter: {
    ...
    compliment:
      "You have the sharp senses and tracking skills needed to capture even the most elusive prey.",
    emoji: "🐾",
  },
  construction: {
  ...
  overall: {
    ...
    color: 0x9b2007,
    placeholder: "https://oldschool.runescape.wiki/images/Combat.png?640a7",
    compliment:
      "You're a true master of all skills, and your accomplishments are legendary.",
    emoji: "📊",
  },
};
