module.exports = {
  ...
  execute(message) {
    if (message.content.includes(`${process.env.prefix}daniel`))
      boye_daniel(message);
    else if (message.content.includes(`${process.env.prefix}daan`))
      boye_daan(message);
    else if (message.content.includes(`${process.env.prefix}julian`))
      boye_julian(message);
    else if (message.content.includes(`${process.env.prefix}ramon`))
      boye_ramon(message);
    else if (message.content.includes(`${process.env.prefix}boyes`))
      boyes(message);
    else if (message.content.includes(`${process.env.prefix}mannen`))
      mannen(message);
  },
};
