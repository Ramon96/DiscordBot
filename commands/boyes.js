...
const boye_daniel = (message) => {
    message.channel.send('Womanizer is niet de enige waar deze man bekend om staat. De man draagt dan ook de verantwoordelijkheid om zijn stad tegen de vele gevaren te beschermen. Healers zijn in deze tijden van corona erg schaars maar dit is geen issue voor de boyes. Ook hechtingen verwijderen is voor Daniel dan ook geen uitdagende klus en doet dit gerust met een glaasje whisky.', {files: ['./images/danielframe.gif']});
}

const boye_daan = (message) => {
    message.channel.send('Ongelofelijk. Dit gaat niet over hoe ongelofelijk lekker hij is, maar elke keer dat de boyes weer iets in hun schild uitvoeren is dit wat er in zijn heerlijke koppie omgaat. De tank die elke party nodig heeft en de man waar elke boye achter mag staan. Heren, Dak van de markt of mangos. Geen enkele feest is gevaar met deze tank in hun nabijheid. ', {files: ['./images/daanframe.gif']});
}
